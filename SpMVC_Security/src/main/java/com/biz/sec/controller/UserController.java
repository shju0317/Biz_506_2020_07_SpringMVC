...
public class UserController {
	...
	public String mypage() {
		...
		// return "mypage"       >> tiles의 definition을 찾아 rendering
		...
		//    1. 또는 2. 에서 해당 설정을 찾게되면 template로 설정된 layout.jsp을 열고
		//    attribute로 설정된 jsp파일들을 loading하여 layout.jsp에 설정된대로
		//    layout을 만들고, HTML로 rendering한 후 response
