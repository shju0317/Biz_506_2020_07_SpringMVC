...
public class OrderServiceImplV1 implements OrderService{
	 ...
	 * 
	 * 이후에 다른 객체, 변수 등을 초기화하려면
	 * 별도의 method를 만든 후 @Autowired를 설정해야 한다.
	 */
	...
	public List<OrderVO> selectAll() {
		...
		System.out.println(orderList); // Dao에서 받은 데이터가 있는지 확인하는 코드(Debugging)
	...
	/*
	 * seq값을 파라미터로 받아서
	 * OrderDao.findBySeq(seq) 호출하고 DB로부터 전달되어 온
	 * 주문서 1개 레코드를 orderVO에 받고
	 * 호출한 곳으로 그대로 return하는 구조
	 * */
	@Override
