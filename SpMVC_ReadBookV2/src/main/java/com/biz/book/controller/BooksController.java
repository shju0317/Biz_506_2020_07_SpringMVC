...
/*
 * @Transactional 어노테이션을 클래스 차원에서 설정하면
...
public class BooksController {
	 ...
	 * <tx:annotation-driven/> 을 설정하고
	 * transaction이 필요한 method에 @Transactional 어노테이션을 설정해주면
	...
	/*
	 * spring form 태그를 taglib를 사용하여 write form을 만들었을 경우에는
